...
//                   <PrimaryButton disabled={false} text={strings.SaveButtonText} onClick={() => this.saveItem()} />
//                 )}
//                 <DefaultButton
//                   disabled={false}
//                   text={strings.CancelButtonText}
//                   onClick={() => this.readData(this.props.listId, this.props.formType, this.props.id)}
//                 />
//               </div>
//             </div>
//           )
...
//           <MessageBar messageBarType={MessageBarType.error} isMultiline={true} onDismiss={ev => this.clearError(idx)}>
//             {item}
//           </MessageBar>
//         ))}
//       </div>
...
//       this.readSchema(nextProps.listId, nextProps.formType).then(() =>
//         this.readData(nextProps.listId, nextProps.formType, nextProps.id)
//       );
...
//       const fieldsSchema = await this.listFormService.getFieldSchemasForForm(this.props.webUrl, listUrl, formType);
